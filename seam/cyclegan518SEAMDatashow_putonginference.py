...
model1 = torch.load("./data/pre_weight/backwardmodel_test499_loss0.0003094713379554874")  ###model_522 + 619
model2 = torch.load("./data/pre_weight/forwardmodel_test499_loss0.0003094713379554874")  ###model_522 + 619
...
if __name__ == '__main__':
    ...
    Gxy = torch.load("./weight/init0model1_pretraing_2shot_test500").cuda()
    Gyx = torch.load("./weight/init0model2_pretraing_2shot_test500").cuda()#0.0077
    ...
    with torch.no_grad():
        ...
        for k in range(0, 325, 1):
            ...
            f2 = np.fromfile("./data/2Dd/SEAM_notime_test7/record_shot31_2ms2001x325.bin", dtype=np.float32).reshape(325, 2001)
